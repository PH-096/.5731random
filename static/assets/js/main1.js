(function() {
    ...
    /**
     Reload*/
    document.addEventListener("DOMContentLoaded", function() {
        const sfwButton = document.getElementById("sfw-button");
        const nsfwButton = document.getElementById("nsfw-button");
        const imageContainer = document.querySelector(".animg");

        sfwButton.addEventListener("click", function(event) {
            event.preventDefault();
            updateImages(false);
        });

        nsfwButton.addEventListener("click", function(event) {
            event.preventDefault();
            updateImages(true);
        });
    ...
    // Check if user's dark mode preference is saved in localStorage
